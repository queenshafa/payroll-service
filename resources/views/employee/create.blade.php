...
@section('content')
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <form action="{{ route('karyawan.store') }}" method="POST" class="space-y-6">
            ...
            <div class="pt-4">
                <button type="submit"
                    class="inline-flex items-center gap-1.5 px-4 py-2 bg-primary text-white text-sm font-medium rounded-lg hover:bg-secondary hover:text-primary transition">
                    Save Data
                </button>
            </div>
        </form>
